...
//tic void onButtonDoubleClickCb1(void *button_handle, void *usr_data) { slPress = true; }
...
//ic void onButtonDoubleClickCb2(void *button_handle, void *usr_data) { ecPress = true; }
...
void _setup_gpio() {
    ...
    //n1->attachDoubleClickEventCb(&onButtonDoubleClickCb1, NULL);
    btn1->attachLongPressStartEventCb(&onButtonHoldCb1, NULL);

    btn2 = new Button(bt2);
    btn2->attachSingleClickEventCb(&onButtonSingleClickCb2, NULL);
    //n2->attachDoubleClickEventCb(&onButtonDoubleClickCb2, NULL);
